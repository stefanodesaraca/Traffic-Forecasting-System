...
class AverageSpeedCleaner(BaseCleaner):
    ...
    def _parse_speeds(self, speeds: pd.DataFrame) -> pd.DataFrame | dd.DataFrame | None:
        ...
        update_trp_metadata(trp_id=trp_id, value=trp_id + "_speeds.csv", metadata_keys_map=["files", "speeds", "raw"], mode="equals")
        ...
        update_trp_metadata(trp_id=trp_id, value=str(t_min), metadata_keys_map=["data_info", "volumes", "start_date"], mode="equals")
        update_trp_metadata(trp_id=trp_id, value=str(t_max), metadata_keys_map=["data_info", "volumes", "end_date"], mode="equals")
