...
dm = ProjectDirectoryManager(global_projects_dir_name=GlobalDefinitions.GLOBAL_PROJECTS_DIR_NAME.value, gp_toolbox=gp_toolbox, global_metadata_manager=global_metadata_manager, pmm=project_metadata_manager)
